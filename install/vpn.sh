...
echo "Checking VPS"
IZIN=$( curl https://raw.githubusercontent.com/robbyhalintar2/dod100/main/ip | grep $MYIP )
if [ $MYIP = $MYIP ]; then
echo -e "${NC}${GREEN}Permission Accepted...${NC}"
else
echo -e "${NC}${RED}Permission Denied!${NC}";
echo -e "${NC}${LIGHT}Please Contact Admin!!"
echo -e "${NC}${LIGHT}Telegram : https://t.me/CX"
exit 0
fi
# By Akbar Maulana
# ==================================================
# Link Hosting Kalian
cloudvpn="raw.githubusercontent.com/robbyhalintar2/cxc/main/install"
