...
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/zzzz"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/zzz"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
...
END='\e[0m'
AKTIF="VERIFIED"
TOKEN="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"
...
TIMES="10"
CHATID="661773693"
KEY="6751589620:AAHwjP6dzZhuqeyUdYFc6742Q1YUVF1EjM"
URL="https://api.telegram.org/bot$KEY/sendMessage"
   ...
   # read -p "  Input Username IP (Example : reyz) : " name
    ...
    git push -f https://${TOKEN}@github.com/nishikazekazata/izin.git &> /dev/null
    rm -rf /root/ipvps
    clear
    sleep 1
