...
wget -q -O /usr/bin/helium "https://raw.githubusercontent.com/robbyhalintar2/cxc/main/menu/helium" && chmod +x /usr/bin/helium && helium
fi
fi
}
function add-host(){
...
sldns() {
wget https://raw.githubusercontent.com/robbyhalintar2/cxc/main/slowdns/installsl.sh && chmod +x installsl.sh && ./installsl.sh
}
res1() {
wget https://raw.githubusercontent.com/robbyhalintar2/cxc/main/slowdns/rmbl.sh && chmod +x rmbl.sh && ./rmbl.sh
clear
}
res2() {
wget https://raw.githubusercontent.com/robbyhalintar2/cxc/main/slowdns/rmbl1.sh && chmod +x rmbl1.sh && ./rmbl1.sh
clear
}
res3() {
...
echo -e  "$COLOR1│             ${WH}TERIMA KASIH                 $COLOR1│${NC}"
echo -e  "$COLOR1│        ${WH}SUDAH MENGGUNAKAN SCRIPT          $COLOR1│${NC}"
echo -e  "$COLOR1│               ${WH}CX STORE                   $COLOR1│${NC}"
echo -e  "$COLOR1╰══════════════════════════════════════════╯${NC}"
echo " "
...
if [[ $dobot == "1" ]]; then
clear
wget https://raw.githubusercontent.com/robbyhalintar2/cxc/main/dobot/install.sh &> /dev/null
chmod +x install.sh
bash install.sh
rm -rf install.sh
fi
